...
|---|---|---|---|
| ① | `01_finite_budget_online/` | converged inference | **done** — PC trains fine with budget ~ depth; unbounded relaxation not needed |
...
| ④ | `04_pc_advantages/`        | backprop's weight transport | **done** — PC-attention trains with *random* feedback (no weight transport) |
